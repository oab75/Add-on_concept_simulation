...
console.log("BufferTable", buffer)
...
for (let bufferIndex = 0; bufferIndex < buffer.length; bufferIndex++) {
    ...
    console.log(bufferIndex, buffer[bufferIndex], buffer.length)
    console.log("end", endStepTime[buffer[bufferIndex].after.unit])
    console.log(bufferIndex, buffer[bufferIndex], buffer.length)
    ...
    if (endStepTime[buffer[bufferIndex].after.unit]) {
        if (endStepTime[buffer[bufferIndex].after.unit][buffer[bufferIndex].after.step]) {
            ...
            console.log("1")
            console.log("1", buffer[bufferIndex].after.unit)
        }
    ...
    if (endStepTime[buffer[bufferIndex].after.unit]) {
        ...
        if (endStepTime[buffer[bufferIndex].after.unit][buffer[bufferIndex].after.step]) {
            ...
            if (
                ...
                console.log("buffer[bufferIndex]", bufferIndex, buffer[bufferIndex])
                console.log("bufferStep", buffer[bufferIndex])
                ...
                console.log("buffer table", buffer,)
                console.log("endStepTime", endStepTime)
                console.log("bufferIndexafter", bufferIndex)
