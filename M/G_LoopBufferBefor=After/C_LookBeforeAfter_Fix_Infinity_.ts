...
var count = 0
var bufferLenghtafter = -2
// var bufferContinueLoop = 1
while( bufferLenghtBefore = bufferLenghtafter){
    // var bufferContinueLoop = true
    var testWhile = 0
...
for (let bufferIndex = 0; bufferIndex < buffer.length; bufferIndex++) {
    ...
    if (endStepTime[buffer[bufferIndex].after.unit]) {
        ...
        console.log("fail No Unit data in endsteptime ")
    }
   
    console.log("end loop element", bufferLenghtBefore, bufferLenghtafter)
